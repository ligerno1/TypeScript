...
# MongoError: Invalid database name: '<database>' ?

You can into TypeScript\快速入门指南\Express\TypeScript-Node-Starter\.env.example , 
set MONGODB_URI_LOCAL=mongodb://localhost:27017/liger  liger is your dbname